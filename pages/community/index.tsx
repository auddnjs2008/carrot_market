...
const Community: NextPage<PostsResponse> = ({ posts }) => {
  ...
  return (
    <Layout seoTitle="Communities" title="동네생활" hasTabBar>
...
export async function getStaticProps() {
  ...
  return {
    ...
    //revalidate: 20  // 이 시간이 지나면 다시 빌드하고 싶다고 말해준다.
  }
}

// getStaticProps는 빌드할 때만 한번 실행이 된다.
// 하지만 ISR을 설정을 해주면 백그라운드에서 몇번이든 실행시킬
// 수 있다. 
