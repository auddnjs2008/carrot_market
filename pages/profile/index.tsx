          ...
          <div className="flex space-x-4 items-center">
            ...
            <div>
              ...
              <div className="flex items-center">
                {[1, 2, 3, 4, 5].map(star => <svg key={star}
...
const MiniProfile = () => {
  ...
  return (
    <div className="flex items-center mt-4 space-x-3">
      {user?.avatar ? (
        <img
          src={`https://imagedelivery.net/gVd53M-5CbHwtF6A9rt30w/${user?.avatar}/avatar`}
...
// reviews 와 miniProfile은 swr을 사용하는 컴포넌트들이다.


const Profile: NextPage = () => {

  return (
    <Layout seoTitle="My Profile" hasTabBar title="나의 캐럿">
      <div className="px-4">
...
// 위에 처럼 suspense 를 true 로 쓰면  swr을 쓰는 모든
// 컴포넌트를 찾아  Suspended 컴포넌트로 만든다.
// suspended란 리액트가 swr의 로딩이 끝나기 전까지 컴포넌트
// 렌더링을 하지 않갰다는 뜻ㅇ디ㅏ. 
